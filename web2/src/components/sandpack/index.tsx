...
// Stub types and components to avoid Sandpack JSX runtime errors
type SandpackFiles = Record<string, string>;
type SandpackInternal = any;
type CodeEditorProps = any;
type SandpackInternalOptions = any;
type SandpackPredefinedTemplate = any;
type TemplateFiles = any;

const SandpackCodeEditor = ({ children, ...props }: any) => <div {...props}>{children}</div>;
const SandpackConsole = ({ children, ...props }: any) => <div {...props}>{children}</div>;
const SandpackFileExplorer = ({ children, ...props }: any) => <div {...props}>{children}</div>;
const SandpackLayout = ({ children, ...props }: any) => <div {...props}>{children}</div>;
const SandpackPreview = ({ children, ...props }: any) => <div {...props}>{children}</div>;
