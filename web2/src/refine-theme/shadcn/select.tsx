...
// Stub components to avoid Radix UI JSX runtime errors
const SelectPrimitive = {
  ...
  ScrollUpButton: React.forwardRef(({ children, ...props }: any, ref) => (
    <button ref={ref} {...props}>{children}</button>
  )),
  ScrollDownButton: React.forwardRef(({ children, ...props }: any, ref) => (
    <button ref={ref} {...props}>{children}</button>
  )),
  ...
  Viewport: React.forwardRef(({ children, ...props }: any, ref) => (
    <div ref={ref} {...props}>{children}</div>
  )),
  Item: React.forwardRef(({ children, ...props }: any, ref) => (
    <div ref={ref} {...props}>{children}</div>
  )),
  ItemText: ({ children, ...props }: any) => <span {...props}>{children}</span>,
  ItemIndicator: ({ children, ...props }: any) => <span {...props}>{children}</span>,
  Label: React.forwardRef(({ children, ...props }: any, ref) => (
    <div ref={ref} {...props}>{children}</div>
  )),
  Separator: React.forwardRef(({ children, ...props }: any, ref) => (
    <div ref={ref} {...props}>{children}</div>
  )),
};
